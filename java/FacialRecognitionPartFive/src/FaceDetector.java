...
public class FaceDetector extends JFrame {
	...
	public java.awt.BufferedImage readImg(String fn, int x, int y) throws IOException{
		int width = x;
		int height = y;
	...
	private static final HaarCascadeDetector detector new HaarCasadeDetector();
	...
	public static void main(String[] args) throws IOException {
		if (args.length == 3) {
			...
			System.out.println("run imageFile.jgp Width Height");
		}
	}
}
